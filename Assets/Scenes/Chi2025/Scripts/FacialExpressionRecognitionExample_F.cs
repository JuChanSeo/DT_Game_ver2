...
namespace OpenCVForUnityExample
{
    ...
    public class FacialExpressionRecognitionExample_F : MonoBehaviour
    {
        [Header("TEST")]
        ...
        public interact_pet_org interact_pet_org;
        ...
        //[SerializeField]
        //private ARTrackedImage trackedimagemanager;
        ...
        void Start()
        {
            ...
            interact_pet_org = GameObject.Find("pomeLV05").GetComponent<interact_pet_org>();
        ...
        /// </summary>
        public unsafe void OnWebCamTextureToMatHelperInitialized()
        {
            ...
            //gameObject.GetComponent<Renderer>().material.mainTexture = texture;
            gameObject.GetComponent<UnityEngine.UI.RawImage>().texture = texture;
        ...
        {
            {
                ...
                else
                {
                    ...
                    string emo_str = facialExpressionRecognizer.visualize(rgbaMat, expressions, faces, false, true);
                    text_emo.text = emo_str.Split(',')[0];
                    if (!interact_pet_org.face_emo) emo_str = "";


                    if (emo_str.Split(',')[0] == "happy")
                    {
                        interact_pet_org.setemotion_nodefault("happy");
                    }
                    else if (emo_str.Split(',')[0] == "surprised")
                    {
                        interact_pet_org.setemotion_nodefault("suprise");
                    }
                    else if (emo_str.Split(',')[0] == "disgust")
                    {
                        interact_pet_org.setemotion_nodefault("angry");
                    }
                    else
                    {
                        interact_pet_org.setemotion_nodefault("normal");
                    }
                }
        ...
        void Update()
        {
            ...
            //else
            //{
            //    Debug.Log("dnn 실핼 실패\t" + webCamTextureToMatHelper.IsPlaying().ToString() + "\t" + webCamTextureToMatHelper.DidUpdateThisFrame().ToString());
            //}
