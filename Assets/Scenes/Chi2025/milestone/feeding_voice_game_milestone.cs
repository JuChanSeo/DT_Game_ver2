...
public class feeding_voice_game_milestone: MonoBehaviour
{
    ...
    Vector3 loc0 = new Vector3(350, 1234, 0);
    Vector3 loc1 = new Vector3(350, 1034, 0);
    Vector3 loc2 = new Vector3(350, 834, 0);
